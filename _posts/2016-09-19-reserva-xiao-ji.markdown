...
![Reserva_Best_MAU](/assets/img/archived/reserva_best_mau.png)
...
![Reserva_Screenshot_1](/assets/img/archived/reserva_screenshot_1.PNG)
![Reserva_Screenshot_2](/assets/img/archived/reserva_screenshot_2.PNG)
![Reserva_Screenshot_3](/assets/img/archived/reserva_screenshot_3.PNG)

再来看看大家关心的 iPhone 型号，以 9/17/16 的数据为例：

![Reserva_Best_Seller_Models](/assets/img/archived/reserva_best_seller_models.png)
...
![DAU_Price_Ratio.png](/assets/img/archived/dau_price_ratio.png)
...
如果你对原始数据感兴趣的话，可以访问这里[下载](/assets/pdf/dau_price_ratio.pdf)到。